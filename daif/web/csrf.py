...
# `/g/` صفحات النزيل: عامة بلا تسجيل دخول، فلا توجد جلسة لوحة يُعلَّق عليها
# رمز الحماية. حمايتها من التزوير عبر الموقع تأتي من مكان آخر — كوكي الإقامة
# بخاصية SameSite=Lax لا يُرسل أصلًا مع طلب POST قادم من موقع غريب، وكل طلب
# يُفحص بعدها مقابل إقامة مفتوحة. وحتى لو نجح طلب مزوّر إلى «دخول»، فالكوكي
# الناتج يقع في متصفح الضحية لا المهاجم، فلا يربح شيئًا.
EXEMPT_PREFIXES = ("/webhook/", "/api/", "/g/")
